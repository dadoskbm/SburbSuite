...
abstract class Quirkf
{
	...
	private static String[] fakeJapanese = {"ã�‚ã�ªã�Ÿã�®ãƒ‡ãƒ¥ã‚¢ãƒ«ãƒ•ã‚©ãƒ¼ã‚¯ã‚’å�–ã‚‹ã€‚äºŒå›žè‡ªåˆ†è‡ªèº«ã‚’ãƒ•ã‚¡ãƒƒã‚¯ã€‚", "ã�‚ã�ªã�Ÿã�«æ€§çš„å¿«æ„Ÿã‚’ä¸Žã�ˆã‚‹ã�Ÿã‚�ã�«å��åˆ†ã�ªåŽšã�•ã�§ã�¯ã�ªã�„ã€‚",
		"ã�‚ã�ªã�Ÿã�¯ã�‚ã�ªã�Ÿã�®è¨€è‘‰ã�§ç§�ã‚’é€€å±ˆç¶šã�‘ã‚‹ã�®ã� ã‚�ã�†ã�‹ï¼Ÿã�¾ã�Ÿã�¯ã€‚ã�‚ã�ªã�Ÿã�¯ç§�ã�®æœ�ã‚’è„±ã��ã�®ã� ã‚�ã�†ã�‹ï¼Ÿ", "ç§�ã�¯ã�‚ã�ªã�Ÿã�®æ­¯ã�®é–“ã�«ç§�ã�®ä¹³é¦–ã‚’æ„Ÿã�˜ã‚‹ã‚ˆã�†ã�«ã�—ã�Ÿã�„ã€‚", "æ™‚ã€…ç§�ã�¯ã€�ã��ã�®ãƒ¡ãƒ¢ãƒªã�«è‡ªæ…°è¡Œç‚ºã€‚",
		"æ€§äº¤ã�‚ã�ªã�Ÿã�¯ä½•ã‚’è©±ã�—ã�¦ã�„ã‚‹ï¼Ÿç™½ç—´é›ŒçŠ¬ã€‚", "æ­£ç¢ºã�«ã�©ã�®ã��ã‚‰ã�„ã�®ã€‚ã�‚ã�ªã�Ÿã�¯çŸ¥ã‚Šã�Ÿã�„ã�§ã�™ã�‹ï¼Ÿ", "ã�‚ã�ªã�Ÿã�¯ç§�ã�«ã�¯ã�§ã��ã�¾ã�›ã‚“ã€‚ã�‚ã�ªã�Ÿã�¯ç§�ã‚’æ€§äº¤ã�™ã‚‹ã�“ã�¨ã�Œã�§ã��ã�ªã�„å ´å�ˆã€‚",
		"ã�„ã�„ã�ˆã‚¯ã‚½æ–¹æ³•ã€‚", "ç½°é‡‘ã€‚ã�—ã�‹ã�—ã€�ã�‚ã�ªã�Ÿã�¯ç§�ã�«å€Ÿã‚Šã�Œã�‚ã‚‹ã€‚æ€§çš„ã�ªæŽ¥å¾…ã€‚", "ã�‚ã�ªã�Ÿã�¯ç§�ã�®èƒ¸ã‚’ã�„ã�¤ã�§ã‚‚è¡¨ç¤ºã�™ã‚‹ã�“ã�¨ã�Œã�§ã��ã�¾ã�™ã€‚", "ç§�ã�®ã�Šã�£ã�±ã�„ã�®ä¸Šã�«ãƒŸãƒ«ã‚¯ã‚’æ³¨ã�„ã�§ã��ã� ã�•ã�„ã€‚",
		"ç§�ã�¯ã��ã‚Œã�Œãƒ©ãƒ•å¥½ã��ã�§ã�™ã€‚ç§�ã�®ä½“ã‚’æŠ¼ã�—ã�¤ã�¶ã�™ã€‚é¦¬ç”·ã€‚", "ã�‚ã�ªã�Ÿã�¯ã€�å¹½éœŠã�®ã‚ˆã�†ã�ªç§�ã�®æ€§å™¨ã�Œæ€§çš„ã‚¯ãƒ©ã‚¤ãƒžãƒƒã‚¯ã‚¹ã‚’æŒ�ã�£ã�¦ã�„ã‚‹ã�“ã�¨ã‚’ç¢ºèª�ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
		"ç§�ã�®è£¸ã�®åº•ã�«ã�‚ã�ªã�Ÿã�®æ±—ã�¾ã�¿ã‚Œã�®é¡”ã‚’ã�“ã�™ã‚‹ã€‚", "ç§�ã�¯ã�‚ã�ªã�Ÿã�®ã‚¢ã‚¸ã‚¢ã�®å¥³å­�é«˜ç”Ÿã�§ã�™ã€‚", "ã�‚ã�ªã�Ÿã�¯ç§�ã‚’å–œã�°ã�›ã‚‹å¿…è¦�ã�Œã�‚ã‚Šã�¾ã�™ã€‚ã�‚ã�ªã�Ÿã�®ãƒ›ãƒ¼ãƒ³ã‚’ä½¿ç”¨ã�—ã�¦ã��ã� ã�•ã�„ã€‚",
		"é�™ã�‹ã�«ã�—ã�¦ã�„ã�¾ã�™ã€‚é»™ã�£ã�¦ç§�ã‚’ãƒ•ã‚¡ãƒƒã‚¯ã€‚", "ç§�ã�®ä½“å†…ã�«å…¥ã‚‹ã€‚", "ã�‚ã�ªã�Ÿã�®ã‚»ãƒƒã‚¯ã‚¹ãƒ©ã‚¤ãƒ•ã�¯ã�©ã�†ã�§ã�™ã�‹ï¼Ÿ", "ä»Šç§�ã‚’ãƒ•ã‚¡ãƒƒã‚¯ã€‚", "ç§�ã�«ãƒªãƒ³ã‚´ã‚’é¤Šã�†ã€‚ã��ã�®å¾Œã€�ç§�ã�®é«ªã‚’ã�¤ã�‹ã‚€ã€‚",
		"ç§�ã�¯ã�‚ã�ªã�Ÿã�®ãƒ›ãƒ¼ãƒ³ã‚’å�¸ã�†ã�“ã�¨ã�Œã�§ã��ã�¾ã�™ã€‚å�Œæ™‚ã�«ã€�ã�‚ã�ªã�Ÿã�¯ç§�ã�®ã�Šå°»ã‚’å¹³æ‰‹æ‰“ã�¡ã€‚ãƒªã‚ºãƒŸã‚«ãƒ«ã�«ã��ã‚Œã‚’è¡Œã�†ã€‚", "æ€§çš„ã‚¨ã‚¯ã‚¹ã‚¿ã‚·ãƒ¼ã‚’ä½“é¨“ã�™ã‚‹ç§�ã�Ÿã�¡ã�®ã�™ã�¹ã�¦ã‚’å¼•ã��èµ·ã�“ã�™ã€‚",
		"ã‚‚ã�£ã�¨ç§�ã‚’ä½Žä¸‹ã�•ã�›ã‚‹ã€‚ç§�ã�¯ã�»ã�¨ã‚“ã�©ã��ã�“ã�«ã�„ã‚‹ã€‚"};
